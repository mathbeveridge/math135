...
slice_plot(cos(3*x)+2~x, bounds(x=-7:7)) + scale_x_continuous(breaks=seq(-2*pi,2*pi,pi/2),labels=c("-2\u03c0","-3\u03c0/2","-\u03c0","-\u03c0/2", "0", "\u03c0/2", "\u03c0", "3\u03c0/2", "2\u03c0"))
...
slice_plot(-7*sin(2*pi/3*x)~x, bounds(x=0:9)) + scale_x_continuous(breaks=seq(0,9,1))
